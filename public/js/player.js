"object" == typeof navigator && function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("playerAwe", t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).playerAwe = t()
 }(this, (function () {
    "use strict";
    ! function () {
    ...
    const C = e => null != e ? e.constructor : null,
       ...
       x = e => Array.isArray(e),
       N = e => E(e, NodeList),
       L = e => S(e) || (P(e) || x(e) || N(e)) && !e.length || A(e) && !Object.keys(e).length;
    var _ = S,
       I = A,
    ...
    function Ne(e) {
       ...
       let i = t(e);
       if (null === i && (i = t(this.config.ratio)), null === i && !z(this.embed) && D(this.embed.ratio) && ({
             ratio: i
    ...
    const ze = {
       ...
       createButton(e, t) {
          ...
          }))) : (a.appendChild(ze.createIcon.call(this, n.icon)), a.appendChild(ze.createLabel.call(this, n.label))), J(i, ae(this.config.selectors.buttons[s], i)), Z(a, i), "play" === s ? (D(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a)) : this.elements.buttons[s] = a, a
       },
       createRange(e, t) {
       ...
       bindMenuItemShortcuts(e, t) {
          be.call(this, e, "keydown keyup", (i => {
             ...
             if (!s && ["Space", "ArrowRight"].includes(i.key)) ze.showMenuPanel.call(this, t, !0);
             else {
                let t;
                "Space" !== i.key && ("ArrowDown" === i.key || s && "ArrowRight" === i.key ? (t = e.nextElementSibling, H(t) || (t = e.parentNode.firstElementChild)) : (t = e.previousElementSibling, H(t) || (t = e.parentNode.lastElementChild)), de.call(this, t, !0))
             }
       ...
       durationUpdate() {
          ...
          !e && this.config.displayDuration && this.paused && ze.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration), e && ze.updateTimeDisplay.call(this, this.elements.display.duration, this.duration), this.config.markers.enabled && ze.setMarkers.call(this), ze.updateSeekTooltip.call(this)
       },
       ...
       getLabel(e, t) {
          switch (e) {
             case "speed":
                return 1 === t ? He.get("normal", this.config) : `${t}×`;
             case "quality":
                if ($(t)) {
       ...
       showMenuPanel(e = "", t = !1) {
          const i = this.elements.container.querySelector(`#playerAwe-settings-${this.id}-${e}`);
          if (!H(i)) return;
       ...
       create(e) {
          ...
          const h = {
             class: "playerAwe__controls__item"
          };
          return Ee(D(this.config.controls) ? this.config.controls : []).forEach((r => {
             ...
             if ("current-time" === r && c.appendChild(a.call(this, "currentTime", h)), "duration" === r && c.appendChild(a.call(this, "duration", h)), "mute" === r || "volume" === r) {
                ...
                if (H(t) && c.contains(t) || (t = ee("div", J({}, h, {
                      class: `${h.class} playerAwe__volume`.trim()
                   ...
                   t.appendChild(n.call(this, "volume", J(i, {
                      id: `playerAwe-volume-${e.id}`
                   })))
                }
             }
             if ("captions" === r && c.appendChild(i.call(this, "captions", h)), "settings" === r && !z(this.config.settings)) {
                const s = ee("div", J({}, h, {
                   class: `${h.class} playerAwe__menu`.trim(),
                   hidden: ""
                }));
                s.appendChild(i.call(this, "settings", {
                   "aria-haspopup": !0,
                   "aria-controls": `playerAwe-settings-${e.id}`,
                   "aria-expanded": !1
                }));
                const n = ee("div", {
                      class: "playerAwe__menu__container",
                      id: `playerAwe-settings-${e.id}`,
                      hidden: ""
                   }),
                   a = ee("div"),
                   r = ee("div", {
                      id: `playerAwe-settings-${e.id}-home`
                   }),
                   o = ee("div", {
                      role: "menu"
                   });
       ...
       inject() {
          if (this.config.loadSprite) {
             ...
             e.cors && Ue(e.url, "sprite-playerAwe")
          }
    ...
    const Qe = {
          setup() {
             ...
             var e, t;
             if (H(this.elements.captions) || (this.elements.captions = ee("div", ae(this.config.selectors.captions)), this.elements.captions.setAttribute("dir", "auto"), e = this.elements.captions, t = this.elements.wrapper, H(e) && H(t) && t.parentNode.insertBefore(e, t.nextSibling)), Q.isIE && window.URL) {
          ...
          update() {
             ...
             })), (a && this.language !== i || !e.includes(n)) && (Qe.setLanguage.call(this, i), Qe.toggle.call(this, t && a)), this.elements && oe(this.elements.container, this.config.classNames.captions.enabled, !z(e)), D(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ze.setCaptionsMenu.call(this)
          },
          toggle(e, t = !0) {
             if (!this.supported.ui) return;
             const {
                toggled: i
             } = this.captions, s = this.config.classNames.captions.active, n = _(e) ? !i : e;
             if (n !== i) {
       ...
       Xe = {
          ...
          selectors: {
             ...
             controls: {
                container: null,
                wrapper: ".playerAwe__controls"
             },
             labels: "[data-playerAwe]",
             buttons: {
                play: '[data-playerAwe="play"]',
                pause: '[data-playerAwe="pause"]',
                restart: '[data-playerAwe="restart"]',
                rewind: '[data-playerAwe="rewind"]',
                fastForward: '[data-playerAwe="fast-forward"]',
                mute: '[data-playerAwe="mute"]',
                captions: '[data-playerAwe="captions"]',
                download: '[data-playerAwe="download"]',
                fullscreen: '[data-playerAwe="fullscreen"]',
                pip: '[data-playerAwe="pip"]',
                airplay: '[data-playerAwe="airplay"]',
                settings: '[data-playerAwe="settings"]',
                loop: '[data-playerAwe="loop"]'
             },
             inputs: {
                seek: '[data-playerAwe="seek"]',
                volume: '[data-playerAwe="volume"]',
                speed: '[data-playerAwe="speed"]',
                language: '[data-playerAwe="language"]',
                quality: '[data-playerAwe="quality"]'
             },
             display: {
                currentTime: ".playerAwe__time--current",
                duration: ".playerAwe__time--duration",
                buffer: ".playerAwe__progress__buffer",
                loop: ".playerAwe__progress__loop",
                volume: ".playerAwe__volume--display"
             },
             progress: ".playerAwe__progress",
             captions: ".playerAwe__captions",
             caption: ".playerAwe__caption"
          },
          classNames: {
             type: "playerAwe--{0}",
             provider: "playerAwe--{0}",
             video: "playerAwe__video-wrapper",
             embed: "playerAwe__video-embed",
             videoFixedRatio: "playerAwe__video-wrapper--fixed-ratio",
             embedContainer: "playerAwe__video-embed__container",
             poster: "playerAwe__poster",
             posterEnabled: "playerAwe__poster-enabled",
             ads: "playerAwe__ads",
             control: "playerAwe__control",
             controlPressed: "playerAwe__control--pressed",
             playing: "playerAwe--playing",
             paused: "playerAwe--paused",
             stopped: "playerAwe--stopped",
             loading: "playerAwe--loading",
             hover: "playerAwe--hover",
             tooltip: "playerAwe__tooltip",
             cues: "playerAwe__cues",
             marker: "playerAwe__progress__marker",
             hidden: "playerAwe__sr-only",
             hideControls: "playerAwe--hide-controls",
             isIos: "playerAwe--is-ios",
             isTouch: "playerAwe--is-touch",
             uiSupported: "playerAwe--full-ui",
             noTransition: "playerAwe--no-transition",
             display: {
                time: "playerAwe__time"
             },
             menu: {
                value: "playerAwe__menu__value",
                badge: "playerAwe__badge",
                open: "playerAwe--menu-open"
             },
             captions: {
                enabled: "playerAwe--captions-enabled",
                active: "playerAwe--captions-active"
             },
             fullscreen: {
                enabled: "playerAwe--fullscreen-enabled",
                fallback: "playerAwe--fullscreen-fallback"
             },
             pip: {
                supported: "playerAwe--pip-supported",
                active: "playerAwe--pip-active"
             },
             airplay: {
                supported: "playerAwe--airplay-supported",
                active: "playerAwe--airplay-active"
             },
             tabFocus: "playerAwe__tab-focus",
             previewThumbnails: {
                thumbContainer: "playerAwe__preview-thumb",
                thumbContainerShown: "playerAwe__preview-thumb--is-shown",
                imageContainer: "playerAwe__preview-thumb__image-container",
                timeContainer: "playerAwe__preview-thumb__time-container",
                scrubbingContainer: "playerAwe__preview-scrubbing",
                scrubbingContainerShown: "playerAwe__preview-scrubbing--is-shown"
             }
          },
          attributes: {
             embed: {
                provider: "data-playerAwe-provider",
                id: "data-playerAwe-embed-id",
                hash: "data-playerAwe-embed-hash"
             }
          },
          ads: {
             enabled: !1,
    ...
    const rt = {
       ...
       build() {
          ...
          }), 0), rt.setTitle.call(this), this.poster && rt.setPoster.call(this, this.poster, !1).catch((() => {})), this.config.duration && ze.durationUpdate.call(this), this.config.mediaMetadata && ze.setMediaMetadata.call(this)
       },
       setTitle() {
       ...
       migrateStyles() {
          Object.values({
             ...this.media.style
          }).filter((e => !z(e) && O(e) && e.startsWith("--playerAwe"))).forEach((e => {
       ...
       constructor(e) {
          t(this, "firstTouch", (() => {
             ...
             if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
                   ...
                   ["Space", "Enter"].includes(t.key) && ("Enter" !== t.key ? (t.preventDefault(), t.stopPropagation(), ze.toggleMenu.call(e, t)) : ze.focusFirstMenuItem.call(e, null, !0))
    ...
    const ut = {
       setup() {
          const e = this;
          oe(e.elements.wrapper, e.config.classNames.embed, !0), e.options.speed = e.config.speed.options, Le.call(e), I(window.Vimeo) ? ut.ready.call(e) : ct(e.config.urls.vimeo.sdk).then((() => {
             ut.ready.call(e)
          })).catch((t => {
    ...
    class kt {
       constructor(e, i) {
          if (t(this, "play", (() => R(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((() => this.ads.play())).catch((() => Ce(this.media.play()))), this.media.play()) : null)), t(this, "pause", (() => this.playing && R(this.media.pause) ? this.media.pause() : null)), t(this, "togglePlay", (e => (j(e) ? e : !this.playing) ? this.play() : this.pause())), t(this, "stop", (() => {
                ...
                if (this.supported.ui && !this.isAudio) {
                   ...
                   if (s && D(this.config.controls) && this.config.controls.includes("settings") && !z(this.config.settings) && ze.toggleMenu.call(this, !1), s !== t) {
             ...
             })), t(this, "supports", (e => me.mime.call(this, e))), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = me.touch, this.media = e, O(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || q(this.media) || D(this.media)) && (this.media = this.media[0]), this.config = J({}, Xe, kt.defaults, i || {}, (() => {
                try {
                   return JSON.parse(this.media.getAttribute("data-playerAwe-config"))
                } catch (e) {
                   return {}
                }
             })()), this.elements = {
                ...
                speed: [],
                quality: []
             }, this.debug = new st(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", me), _(this.media) || !H(this.media)) return void this.debug.error("Setup failed: no suitable element passed");
          if (this.media.playerAwe) return void this.debug.warn("Target already setup");
          ...
          this.supported = me.check(this.type, this.provider, this.config.playsinline), this.supported.api ? (this.eventListeners = [], this.listeners = new ot(this), this.storage = new Fe(this), this.media.playerAwe = this, H(this.elements.container) || (this.elements.container = ee("div", {
             tabindex: 0
       ...
       static setup(e, t = {}) {
          let i = null;
          return O(e) ? i = Array.from(document.querySelectorAll(e)) : q(e) ? i = Array.from(e) : D(e) && (i = e.filter(H)), z(i) ? null : i.map((e => new kt(e, t)))
       }
    }
    var Ct;
