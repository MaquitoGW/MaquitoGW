...
if (isset($_GET['upload'])) {
    ...
    <div class="path">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="_token" value="<?php echo CSFR_TOKEN; ?>" autocomplete="off">
...
<form action="" method="post">
    ...
    <p><button type="submit" name="delete" class="icon del" value="Delete" onclick="return confirm('Delete selected files and folders?')"><svg class="svg-inline--fa fa-trash fa-w-14" aria-hidden="true" focusable="false" data-prefix="fa-regular" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                <path fill="currentColor" d="M424 80H349.625L315.625 23.25C306.875 8.875 291.25 0 274.375 0H173.625C156.75 0 141.125 8.875 132.375 23.25L98.375 80H24C10.745 80 0 90.745 0 104V104C0 117.255 10.745 128 24 128H32L53.25 467C54.75 492.25 75.75 512 101.125 512H346.875C372.25 512 393.25 492.25 394.75 467L416 128H424C437.255 128 448 117.255 448 104V104C448 90.745 437.255 80 424 80ZM173.625 48H274.375L293.625 80H154.375L173.625 48ZM346.875 464H101.125L80.125 128H367.875L346.875 464Z"></path>
            </svg>Delete</button>
        <button type="submit" name="copy" class="icon" value="Copy"><svg class="svg-inline--fa fa-copy fa-w-16" aria-hidden="true" focusable="false" data-prefix="fa-regular" data-icon="copy" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                <path fill="currentColor" d="M502.646 70.625L441.393 9.375C435.391 3.371 427.252 0 418.766 0H256C220.652 0 191.998 28.656 192 64.004L192.02 320.004C192.021 355.352 220.676 384 256.02 384H448.02C483.219 384 512.02 355.199 512.02 320V93.254C512.02 84.766 508.648 76.629 502.646 70.625ZM464.021 320C464.021 328.836 456.857 336 448.021 336H256.018C247.18 336 240.018 328.836 240.018 320L240 64.125C240 55.289 247.164 48.125 256 48.125H384.027V96C384.027 113.672 398.354 128 416.027 128H464.021V320ZM272.021 448C272.021 456.836 264.857 464 256.021 464H64.018C55.18 464 48.018 456.836 48.018 448L48 192.125C48 183.289 55.164 176.125 64 176.125H160.02V128H64C28.652 128 -0.002 156.656 0 192.004L0.02 448.004C0.021 483.352 28.676 512 64.02 512H256.02C291.219 512 320.02 483.199 320.02 448V416H272.021V448Z"></path>
            </svg>Copy</button>
    </p>
</form>
